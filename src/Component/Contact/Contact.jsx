...
const Contact = () => {
    ...
    return (
        <div className="font-Meri ">
            ...
            <div className="max-w-6xl my-28 mx-auto">
                <section data-aos="fade-up"
                data-aos-duration="1000" className="py-8  bg-[#b7004f1c] rounded-xl">
                    <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                        <div className="py-6 md:py-0 md:px-6">
                            ...
                            <div className="space-y-4">
                                <p className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 text-[#b70050] h-5 mr-2 sm:mr-6">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col py-6 space-y-6 font-Mulish md:py-0 md:px-6">
                            ...
                            <button type="submit" className="self-centeroutline-none bg-transparent   border border-[#b70050] text-[#b70050] rounded-md p-2  hover:text-white hover:bg-[#b70050] transition-all duration-1000  px-8 py-3 text-lg focus:ring w-full focus:ring-opacity-75 font-bold  ">Submit</button>
                        </form>
                    </div>
                </section>
            </div>
