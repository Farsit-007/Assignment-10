        ...
        <div className="">
            <div className={`navbar lg:px-20 transition-all duration-1000 text-white z-10 fixed top-0 left-0 right-0 bg-transparent ${active ? "activecls" : ""}`}>
                ...
                </div>
                {
                    ...
                    //         <li className="text-black"><p>{user?.displayName || "User Name"}</p></li>
                    //         <li><a><Link to='/login' onClick={handleLogout} className="w-full text-black text-[16px] font-bold">Logout</Link></a></li>
                    //     </ul>
                    // </div> 
                    user ? <div><a id="clickable"><div className="w-[45px] cursor-pointer rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                        ...
                        <div className="navbar-end flex items-center gap-2  md:pl-8"><Link to='/login' className="text-[16px] font-bold btn bg-transparent text-white">Login</Link>
                            <Link to='/register' className="text-[16px] font-bold btn bg-transparent text-white">Register</Link></div>
